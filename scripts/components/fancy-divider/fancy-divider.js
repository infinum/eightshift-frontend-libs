...
export const FancyDivider = (props) => {
	...
	if (!icon) {
		return (
			<div className={`es-h-spaced es-mt-3 es-mb-2.5 es-nested-p-0.75 es-nested-bg-cool-gray-450 es-nested-rounded-1 es-nested-color-pure-white es-color-cool-gray-600 ${additionalClasses ?? ''}`}>
				{!subtitle && label}
