...
export const FancyDivider = (props) => {
	...
	if (!icon) {
		return (
			<div className={`es-h-spaced es-mt-0 es-mb-2.5 es-nested-p-0.75 es-nested-bg-cool-gray-450 es-nested-rounded-1.0 es-nested-color-pure-white es-color-cool-gray-500 ${additionalClasses ?? ''}`}>
				{label}
	...
	return (
		<div className={`es-h-spaced es-mt-0 es-mb-2.5 es-nested-p-0.75 es-color-cool-gray-500 ${additionalClasses ?? ''}`}>
