			...
			renderToggle={(appenderProps) => {
				...
				return (
					<Button
						...
						icon={icons.add}
						className={classnames('es-slight-button-border-cool-gray-400 es-hover-slight-button-border-admin-accent es-active-slight-button-border-admin-accent es-focus-slight-button-border-admin-accent', 'es-bg-pure-white! es-mx-auto es-text-3! es-color-cool-gray-650', !hasLabel && !small && 'es-w-9!', small ? 'es-h-7! es-w-7! es-min-w-7! es-rounded-1! es-button-icon-18' : 'es-button-icon-20 es-rounded-1.5! es-h-9!')}
