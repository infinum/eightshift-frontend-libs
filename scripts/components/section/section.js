			...
			<Collapsable
				label={
					<IconLabel
						...
						label={label}
						subtitle={subtitle}
						additionalClasses='es-nested-bg-cool-gray-450 es-nested-rounded-1 es-nested-color-pure-white! es-nested-p-0.75 es-color-cool-gray-600 es-has-enhanced-contrast-icon'
						standalone
					/>
				}
